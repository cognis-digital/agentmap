"""Native cognis-connect emit for agentmap — forward findings to any platform.

Maps agentmap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    agentmap ... --format json | agentmap-emit --to stix
    agentmap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
